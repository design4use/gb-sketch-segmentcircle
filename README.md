...
## Brand new version 2.03
Completely rewritten v2 plugin, now also creating variable values pie chart segments, perfectly spaced dashed circles and tick mark graphics. 2.02 adds support for Sketch v39, 2.03 for Sketch v40+
